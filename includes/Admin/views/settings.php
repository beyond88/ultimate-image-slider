                                        ...
                                        <tr class="uis-field">
                                            ...
                                            <td class="uis-control">
                                                <div class="uis-control-wrapper">
                                                    ...
                                                    <input type="text" name="uis-settings[slider_heading][]" class="" placeholder="<?php echo __('Enter slider heading', 'ultimate-image-slider');?>">
                                                </div>
                                            </td>
                                            <td class="uis-control">
                                                <div class="uis-control-wrapper">
                                                    <h4><?php echo __('Description', 'ultimate-image-slider'); ?></h4>
                                                    <textarea name="uis-settings[slider_desc][]" class="" placeholder="<?php echo __('Enter slider description', 'ultimate-image-slider');?>"></textarea>
                                                </div>
                                            </td>
                                            <td class="uis-control">
                                                <div class="uis-control-wrapper">
                                            ...
                                            <td class="middle-align">
                                                <div class="uis-click-area-wrapper">
                                                    ...
                                                    <label for="add-field" class="uis-group-field-add">
                                                        ...
                                                        <span class="uis_add_field_label">Add New Slide</span>
